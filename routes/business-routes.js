...
router.get('/customer/appointments', auth, function (req, res, next) {
 ...
 */
router.post('/appointments/update', auth, function (req, res, next) {
...
router.post('/appointment/charge', auth, function (req, res, next) {
...
router.post('/appointment/status-update', auth, function (req, res, next) {
    var appointmentId = req.body._id;
    Appointment.findOne({'_id': appointmentId}).populate([[
        {path: 'customer', select: '_id firstName lastName name email'},
        {path: 'employee', select: '_id firstName lastName name email'}
 ...
 */
router.post('/appointments/cancel', auth, function (req, res, next) {
